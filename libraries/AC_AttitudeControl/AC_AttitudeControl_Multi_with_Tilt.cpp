#include "AC_AttitudeControl_Multi_with_Tilt.h"
...
void AC_AttitudeControl_Multi_with_Tilt::rate_controller_run() {
...
void AC_AttitudeControl_Multi_with_Tilt::input_euler_angle_roll_pitch_euler_rate_yaw(float euler_roll_angle_cd, float euler_pitch_angle_cd, float euler_yaw_rate_cds) {
...
void AC_AttitudeControl_Multi_with_Tilt::input_euler_angle_roll_pitch_yaw(float euler_roll_angle_cd, float euler_pitch_angle_cd, float euler_yaw_angle_cd, bool slew_yaw) {
...
void AC_AttitudeControl_Multi_with_Tilt::input_thrust_vector_rate_heading(const Vector3f& thrust_vector, float heading_rate_cds, bool slew_yaw)
{
...
void AC_AttitudeControl_Multi_with_Tilt::input_thrust_vector_heading(const Vector3f& thrust_vector, float heading_angle_cd, float heading_rate_cds)
{
    // convert thrust vector to a roll and pitch angles
    Vector3f angle_target = attitude_from_thrust_vector(thrust_vector, _ahrs.yaw).to_vector312();
...
void AC_AttitudeControl_Multi_with_Tilt::set_forward_lateral(float &euler_pitch_angle_cd, float &euler_roll_angle_cd)
{
    ...
    if (forward_enable) {
        ...
        euler_pitch_angle_cd = aim_roll * 100.0f;
    } else {
...
void AC_AttitudeControl_Multi_with_Tilt::input_euler_rate_yaw_euler_angle_pitch_bf_roll(bool plane_controls, float euler_roll_angle_cd, float euler_pitch_angle_cd, float euler_yaw_rate_cds) {
    _motors.set_lateral(0.0f);
    _motors.set_forward(0.0f);
...
void AC_AttitudeControl_Multi_with_Tilt::input_euler_rate_roll_pitch_yaw(float euler_roll_rate_cds, float euler_pitch_rate_cds, float euler_yaw_rate_cds) {
    _motors.set_lateral(0.0f);
    _motors.set_forward(0.0f);
...
void AC_AttitudeControl_Multi_with_Tilt::input_rate_bf_roll_pitch_yaw(float roll_rate_bf_cds, float pitch_rate_bf_cds, float yaw_rate_bf_cds) {
    _motors.set_lateral(0.0f);
    _motors.set_forward(0.0f);
...
// Command an angular velocity with angular velocity feedforward and smoothing
void AC_AttitudeControl_Multi_with_Tilt::input_rate_bf_roll_pitch_yaw_2(float roll_rate_bf_cds, float pitch_rate_bf_cds, float yaw_rate_bf_cds) {
    _motors.set_lateral(0.0f);
    _motors.set_forward(0.0f);
...
void AC_AttitudeControl_Multi_with_Tilt::input_rate_bf_roll_pitch_yaw_3(float roll_rate_bf_cds, float pitch_rate_bf_cds, float yaw_rate_bf_cds) {
    _motors.set_lateral(0.0f);
    _motors.set_forward(0.0f);
...
void AC_AttitudeControl_Multi_with_Tilt::input_angle_step_bf_roll_pitch_yaw(float roll_angle_step_bf_cd, float pitch_angle_step_bf_cd, float yaw_angle_step_bf_cd) {
    _motors.set_lateral(0.0f);
    _motors.set_forward(0.0f);
...
void AC_AttitudeControl_Multi_with_Tilt::input_quaternion(Quaternion& attitude_desired_quat, Vector3f ang_vel_target) {
#if CONFIG_HAL_BOARD == HAL_BOARD_SITL
    AP_HAL::panic("input_quaternion not implemented AC_AttitudeControl_Multi_with_Tilt");
#endif
...
AC_AttitudeControl_Multi_with_Tilt *AC_AttitudeControl_Multi_with_Tilt::_singleton = nullptr;
