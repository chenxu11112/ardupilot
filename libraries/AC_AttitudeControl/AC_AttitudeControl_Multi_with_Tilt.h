...
class AC_AttitudeControl_Multi_with_Tilt : public AC_AttitudeControl_Multi {
public:
    AC_AttitudeControl_Multi_with_Tilt(AP_AHRS_View &ahrs, const AP_Vehicle::MultiCopter &aparm, AP_MotorsMulticopter& motors, float dt):
        AC_AttitudeControl_Multi(ahrs,aparm,motors,dt) {

        if (_singleton != nullptr) {
            AP_HAL::panic("Can only be one AC_AttitudeControl_Multi_with_Tilt");
        }
        _singleton = this;
    }

    static AC_AttitudeControl_Multi_with_Tilt *get_singleton() {
        return _singleton;
    }
...
private:
    ...
    static AC_AttitudeControl_Multi_with_Tilt *_singleton;
