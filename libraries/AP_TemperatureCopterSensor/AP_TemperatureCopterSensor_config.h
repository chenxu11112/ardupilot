...
#ifndef AP_TEMPERATURE_COPTER_SENSOR_ENABLED
#if HAL_MINIMIZE_FEATURES || BOARD_FLASH_SIZE <= 1024
    #define AP_TEMPERATURE_COPTER_SENSOR_ENABLED 0
#elif (CONFIG_HAL_BOARD == HAL_BOARD_SITL)
    #define AP_TEMPERATURE_COPTER_SENSOR_ENABLED 1
#else
    #define AP_TEMPERATURE_COPTER_SENSOR_ENABLED 2
#endif
#endif
...
#ifndef AP_TEMPERATURE_COPTER_SENSOR_MAX_INSTANCES
#define AP_TEMPERATURE_COPTER_SENSOR_MAX_INSTANCES             6
#endif
