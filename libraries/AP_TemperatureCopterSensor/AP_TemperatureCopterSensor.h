...
#include "AP_TemperatureCopterSensor_config.h"
...
class AP_TemperatureCopterSensor_TSYS01;
class AP_TemperatureCopterSensor_Analog;


class AP_TemperatureCopterSensor
{
    friend class AP_TemperatureCopterSensor_Backend;
    friend class AP_TemperatureCopterSensor_TSYS01;
    friend class AP_TemperatureCopterSensor_Analog;
...
public:
    ...
    CLASS_NO_COPY(AP_TemperatureCopterSensor);

    static AP_TemperatureCopterSensor *get_singleton() { return _singleton; }
    ...
    // accessors to params
    AP_TemperatureCopterSensor_Params::Type get_type(const uint8_t instance = AP_TEMPERATURE_SENSOR_PRIMARY_INSTANCE) const;
    AP_TemperatureCopterSensor_Params::Source get_source(const uint8_t instance = AP_TEMPERATURE_SENSOR_PRIMARY_INSTANCE) const;
