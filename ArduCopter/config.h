...
//
// 请不要编辑此文件以调整配置。请创建自己的
// APM_Config.h 并参考 APM_Config.h.example 进行配置。
//
// 警告警告警告警告警告警告警告警告警告警告警告
///
//////////////////////////////////////////////////////////////////////////////
...
// 维护者注意事项：
//
// - 尝试保持此文件的组织结构与 APM_Config.h.example 相同的顺序
//
#include "defines.h"

///
/// 请不要编辑此包含文件 - 如果要进行本地更改，请在本地副本的 APM_Config.h 中进行更改。
///
...
# define RANGEFINDER_HEALTH_MAX 3 // 表示一个健康的距离传感器需要具备的良好读数次数
#endif

#ifndef RANGEFINDER_TIMEOUT_MS
# define RANGEFINDER_TIMEOUT_MS 1000 // 如果传感器在 1 秒内没有更新数据，将重置距离传感器滤波器
#endif

#ifndef RANGEFINDER_FILT_DEFAULT
# define RANGEFINDER_FILT_DEFAULT 0.5f // 距离传感器距离的滤波器系数默认值
#endif

#ifndef SURFACE_TRACKING_TIMEOUT_MS
# define SURFACE_TRACKING_TIMEOUT_MS 1000 // 如果在指定的时间内没有得到有效的距离传感器高度，地面跟踪目标高度将重置为当前的距离传感器高度
#endif

#ifndef RANGEFINDER_TILT_CORRECTION // 是否禁用倾斜校正以便 EKF 使用距离传感器数据
# define RANGEFINDER_TILT_CORRECTION ENABLED
#endif

#ifndef RANGEFINDER_GLITCH_ALT_CM
# define RANGEFINDER_GLITCH_ALT_CM 200 // 将被视为数据异常的距离传感器高度变化量
#endif

#ifndef RANGEFINDER_GLITCH_NUM_SAMPLES
# define RANGEFINDER_GLITCH_NUM_SAMPLES 3 // 连续出现多少次距离传感器高度异常以采集新读数
#endif
...
# define GPS_HDOP_GOOD_DEFAULT 140 // 表示良好位置的最小 HDOP。如果启用了围栏，将在预解锁检查期间使用
#endif

// 丢失地形数据的失控保护
#ifndef FS_TERRAIN_TIMEOUT_MS
# define FS_TERRAIN_TIMEOUT_MS 5000 // 5 秒的丢失地形数据将触发失控保护（RTL）
#endif

// 预解锁气压计与惯性导航最大高度差异
#ifndef PREARM_MAX_ALT_DISPARITY_CM
# define PREARM_MAX_ALT_DISPARITY_CM 100 // 气压计与惯性导航的高度必须在此范围内，以确保解锁
#endif

//////////////////////////////////////////////////////////////////////////////
// EKF 失控保护
#ifndef FS_EKF_ACTION_DEFAULT
# define FS_EKF_ACTION_DEFAULT FS_EKF_ACTION_LAND // 默认情况下，EKF 失控保护触发着陆
#endif
#ifndef FS_EKF_THRESHOLD_DEFAULT
# define FS_EKF_THRESHOLD_DEFAULT 0.8f // EKF 失控保护的默认指南针和速度方差阈值，超过此阈值将触发 EKF 失控保护
#endif

#ifndef EKF_ORIGIN_MAX_ALT_KM
# define EKF_ORIGIN_MAX_ALT_KM 50 // EKF 坐标原点和家位置的垂直最大距离，单位千米
#endif
...
# define DEFAULT_LOG_BITMASK \
     MASK_LOG_ATTITUDE_MED | MASK_LOG_GPS | MASK_LOG_PM | MASK_LOG_CTUN | MASK_LOG_NTUN | MASK_LOG_RCIN | MASK_LOG_IMU | MASK_LOG_CMD | MASK_LOG_CURRENT | MASK_LOG_RCOUT | MASK_LOG_OPTFLOW | MASK_LOG_COMPASS | MASK_LOG_CAMERA | MASK_LOG_MOTBATT
#endif
